...
<%@ Register Src="../Sublayouts/GAMonitor.ascx" TagName="Monitor" TagPrefix="GA" %>
...
<body>
	<form method="post" runat="server" id="mainform">
			...
			<div class="header">
				...
				<div class="nav">
					<asp:Repeater ID="rptNav" runat="server">
						...
						<ItemTemplate>
							<li><a value="1" tag="<%# GetTag((Item)Container.DataItem) %>" href="<%# LinkManager.GetItemUrl((Item)Container.DataItem) %>"><%# ((Item)Container.DataItem).DisplayName %></a></li>
						</ItemTemplate>
		...
		<GA:Monitor runat="server" id="gaMonitor" />
    </form>
</body>
</html>
